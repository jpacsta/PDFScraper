...
while count <= TotalPages:
    ...
    # Search for Comp_ID
    results_comp_id = re.finditer(pattern_comp_id, pdf)
    for result_search_comp_id in results_comp_id:
        start_index = result_search_comp_id.start()
        end_index = result_search_comp_id.end()
